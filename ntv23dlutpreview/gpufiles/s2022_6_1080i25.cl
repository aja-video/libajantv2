void kernel S2022_6_1080i25(global const uchar* input, __write_only image2d_t output)
{
    ...
    {
        // Field 2
        lineOffset = 21; // this essentially deinterlaces
        //lineOffset = 584;

    }

    uint startIndex;
    startIndex = 1800 + rowChars*(lineOffset+(outputLine/2));

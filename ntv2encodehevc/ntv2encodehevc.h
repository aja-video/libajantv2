/**
	@file		ntv2encodehevc.h
	@brief		Declares the NTV2EncodeHEVC class.
...
class NTV2EncodeHEVC
{
	...
	public:
		/**
            ...
            @param[in]	inInfoMode          Use picture and encoded information.
                                            Defaults to no info data.
            @param[in]	inTsiMode           Use two sample interleave mode for UHD/4K.
                                            Defaults to square division mode.
            @param[in]	inMaxFrames			Specifies the maximum number of frames to capture.
            								Defaults to 0xFFFFFFFF (unlimited).
        **/
		NTV2EncodeHEVC (const std::string			inDeviceSpecifier	= "0",
                        ...
                        const bool                  inInfoMode          = false,
                        const bool                  inTsiMode			= false,

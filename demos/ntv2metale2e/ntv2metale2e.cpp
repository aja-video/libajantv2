...
AJAStatus NTV2MetalE2E::Init (void)
{
    mDevice.Open(0);
...
AJAStatus NTV2MetalE2E::SetUpVideo (void)
{
	...
	bool isValidVPID (mDevice.GetVPIDValidA(inChannel));
	if (isValidVPID)
	{
		CNTV2VPID inputVPID;
...
static const int64_t ntv2_reg_spi_reset		= 0x8010;
static const int64_t ntv2_reg_spi_control	= 0x8018;
static const int64_t ntv2_reg_spi_status	= 0x8019;
static const int64_t ntv2_reg_spi_write		= 0x801a;
static const int64_t ntv2_reg_spi_read		= 0x801b;
static const int64_t ntv2_reg_spi_slave		= 0x801c;

static const int64_t ntv2_reg_out_freq1		= 0x36c1;
static const int64_t ntv2_reg_out_freq2		= 0x36c2;
static const int64_t ntv2_reg_out_freq3		= 0x36c3;
static const int64_t ntv2_reg_out_freq4		= 0x36c4;
static const int64_t ntv2_reg_out_freq5		= 0x36c5;
...
// Genlock Helpers
void NTV2MetalE2E::spi_reset(struct ntv2_genlock2 *ntv2_gen)
{
...
void NTV2MetalE2E::spi_reset_fifos(struct ntv2_genlock2 *ntv2_gen)
{
	//reg_write(ntv2_gen, ntv2_reg_spi_control, 0x1e6);
	reg_write(ntv2_gen, ntv2_reg_spi_control, 0x1fe);
}

bool NTV2MetalE2E::spi_wait_write_empty(struct ntv2_genlock2 *ntv2_gen)
{
	//uint32_t status = 0;
...
bool NTV2MetalE2E::spi_wait_read_not_empty(struct ntv2_genlock2 *ntv2_gen)
{
	uint32_t status = 0;
	uint32_t count = 0;
...
bool NTV2MetalE2E::reset_dtr_status(struct ntv2_genlock2 *ntv2_gen)
{
...
bool NTV2MetalE2E::spi_genlock2_write(struct ntv2_genlock2 *ntv2_gen, uint32_t size, uint16_t addr, uint8_t* data, bool triggerWait)
{
	uint32_t controlVal;
...
bool NTV2MetalE2E::spi_genlock2_read(struct ntv2_genlock2 *ntv2_gen, uint16_t addr, uint8_t* data, uint32_t numBytes)
{
	uint32_t  val, status;
...
uint32_t NTV2MetalE2E::reg_read(struct ntv2_genlock2 *ntv2_gen, const uint32_t *reg)
{
	ULWord regData (0);
	mDevice.ReadRegister(reg, regData);
	return regData;	
}

void NTV2MetalE2E::reg_write(struct ntv2_genlock2 *ntv2_gen, const uint32_t *reg, uint32_t data)
{

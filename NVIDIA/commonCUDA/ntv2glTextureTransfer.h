...
#ifndef _NTV2_GL_TEXTURE_TRANSFER_
#define _NTV2_GL_TEXTURE_TRANSFER_
...
/* An abstract class representing the method by which a frame of video is
   transferred from the AJA hardware to an OpenGL texture.*/
class CNTV2glTextureTransfer {
public:	
	virtual ~CNTV2glTextureTransfer(){};

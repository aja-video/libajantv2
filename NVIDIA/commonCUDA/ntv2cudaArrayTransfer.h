...
#ifndef _NTV2_CUDA_ARRAY_TRANSFER_
#define _NTV2_CUDA_ARRAY_TRANSFER_
...
/* An abstract class representing the method by which a frame of video is
   transferred from the AJA hardware to a CUDA array.*/
class CNTV2cudaArrayTransfer {
public:	
	virtual ~CNTV2cudaArrayTransfer(){};

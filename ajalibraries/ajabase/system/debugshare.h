...
typedef enum _AJADebugUnit
{
    ...
    AJA_DebugUnit_AJAAncLib					= 13,
    AJA_DebugUnit_QuickTime					= 14,
    AJA_DebugUnit_ControlPanel				= 15,
    AJA_DebugUnit_Watcher				    = 16,
    AJA_DebugUnit_Plugins                   = 17,
    AJA_DebugUnit_CCLine21Decode			= 18,
    AJA_DebugUnit_CCLine21Encode			= 19,
    AJA_DebugUnit_CC608DataQueue			= 20,
    AJA_DebugUnit_CC608MsgQueue				= 21,
    AJA_DebugUnit_CC608Decode				= 22,
    AJA_DebugUnit_CC608DecodeChannel		= 23,
    AJA_DebugUnit_CC608DecodeScreen			= 24,
    AJA_DebugUnit_CC608Encode				= 25,
    AJA_DebugUnit_CC708Decode				= 26,
    AJA_DebugUnit_CC708Service				= 27,
    AJA_DebugUnit_CC708ServiceBlockQueue	= 28,
    AJA_DebugUnit_CC708Window				= 29,
    AJA_DebugUnit_CC708Encode				= 30,
    AJA_DebugUnit_CCFont					= 31,
    AJA_DebugUnit_SMPTEAnc					= 32,
    ...
    //
    AJA_DebugUnit_FirstUnused               = 33,
    AJA_DebugUnit_Unused_33                 = AJA_DebugUnit_FirstUnused,
    ...
    AJA_DebugUnit_Unused_45                 = 45,
    AJA_DebugUnit_Unused_46                 = 46,
    AJA_DebugUnit_Unused_47                 = 47,
    AJA_DebugUnit_Unused_48                 = 48,
    AJA_DebugUnit_Unused_49                 = 49,

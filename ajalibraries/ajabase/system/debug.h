 ...
 *  @param[in]	_severity_	Severity (@link AJA_DEBUG_SEVERITY@endlink) of the message to report.
...
public:
	 ...
	 *	@param[in]	severity	Severity (@link AJA_DEBUG_SEVERITY@endlink) of the message to report.

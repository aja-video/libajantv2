...
typedef enum
{
	...
	DEVICE_ID_KONAIP_4CH_1SFP_J2K	= 0x10646702,
...
typedef enum
{
	...
	NTV2_STANDARD_3840x2160p,	// HDMI only for now
	NTV2_STANDARD_4096x2160p,	// HDMI only for now
	NTV2_STANDARD_3840HFR,		// HDMI only for now
	NTV2_STANDARD_4096HFR,		// HDMI only for
	NTV2_NUM_STANDARDS,
...
typedef enum
{
	...
	NTV2_BITFILE_KONAIP_4CH_1SFP_J2K= 46,

...
typedef enum
{
    ...
    kRegMaskEHParamBitRate              = 0xFFFF,
    kRegMaskEHParamVBRMaxBitRate        = 0xFFFF,
    kRegMaskEHParamVBRAveBitRate        = 0xFFFF,
    kRegMaskEHParamPrivate09            = 0xFFFF,
    kRegMaskEHParamPrivate10            = 0xFFFF,
    kRegMaskEHParamNumUnitsInTickMax    = 0xFFFF,
    kRegMaskEHParamTimeScale            = 0xFFFF,
    kRegMaskEHParamNumUnitsInTick       = 0xFFFF,
    kRegMaskEHParamCPBDelay             = 0xFFFF,

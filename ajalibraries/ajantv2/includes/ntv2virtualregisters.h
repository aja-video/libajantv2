...
typedef enum
{
	...
	kVReg2022_2EncodeVideoFormatCh1			= VIRTUALREG_START+479,
	kVReg2022_2EncodeUllModeCh1				= VIRTUALREG_START+480,
	kVReg2022_2EncodeBitDepthCh1			= VIRTUALREG_START+481,
	kVReg2022_2EncodeChromaSubSampCh1		= VIRTUALREG_START+482,
	kVReg2022_2EncodeCodeBlockSizeCh1		= VIRTUALREG_START+483,
	kVReg2022_2EncodeMbpsCh1				= VIRTUALREG_START+484,
	kVReg2022_2EncodePidCh1					= VIRTUALREG_START+485,
	kVReg2022_2EncodeStreamTypeCh1			= VIRTUALREG_START+486,

	kVReg2022_2EncodeVideoFormatCh2			= VIRTUALREG_START+487,
	kVReg2022_2EncodeUllModeCh2				= VIRTUALREG_START+488,
	kVReg2022_2EncodeBitDepthCh2			= VIRTUALREG_START+489,
	kVReg2022_2EncodeChromaSubSampCh2		= VIRTUALREG_START+490,
	kVReg2022_2EncodeCodeBlockSizeCh2		= VIRTUALREG_START+491,
	kVReg2022_2EncodeMbpsCh2				= VIRTUALREG_START+492,
	kVReg2022_2EncodePidCh2					= VIRTUALREG_START+493,
	kVReg2022_2EncodeStreamTypeCh2			= VIRTUALREG_START+494,

	kVReg2022_7Enable						= VIRTUALREG_START+495,
	
	kVRegUserDefinedDBB						= VIRTUALREG_START+496,

	kVRegHDMIOutAudioChannels				= VIRTUALREG_START+497,
	kVRegHDMIOutRGBRange					= VIRTUALREG_START+498,

	kVRegLastAJA							= VIRTUALREG_START+498,		///< @brief	The last AJA virtual register slot

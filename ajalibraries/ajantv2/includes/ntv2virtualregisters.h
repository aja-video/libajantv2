...
typedef enum
{
	...
	kVRegRxcNetworkPathDiff1				= VIRTUALREG_START+429,
	kVRegRxcPlayoutDelay1					= VIRTUALREG_START+430,
	kVRegRxcUnused1							= VIRTUALREG_START+431,
	...
	kVRegRxcPrimaryVlan2					= VIRTUALREG_START+438,
	kVRegRxcSecondaryRxMatch2				= VIRTUALREG_START+439,
	kVRegRxcSecondarySourceIp2				= VIRTUALREG_START+440,
	kVRegRxcSecondaryDestIp2				= VIRTUALREG_START+441,
	kVRegRxcSecondarySourcePort2			= VIRTUALREG_START+442,
	kVRegRxcSecondaryDestPort2				= VIRTUALREG_START+443,
	kVRegRxcSecondaryVlan2					= VIRTUALREG_START+444,
	kVRegRxcSsrc2							= VIRTUALREG_START+445,
	kVRegRxcNetworkPathDiff2				= VIRTUALREG_START+446,
	kVRegRxcPlayoutDelay2					= VIRTUALREG_START+447,
	kVRegRxcUnused2							= VIRTUALREG_START+448,
	...
	kVRegTxcSecondaryLocalPort3				= VIRTUALREG_START+453,
	kVRegTxcSecondaryRemoteIp3				= VIRTUALREG_START+454,
	kVRegTxcSecondaryRemotePort3			= VIRTUALREG_START+455,

	kVRegTxcEnable4							= VIRTUALREG_START+456,
	kVRegTxcPrimaryLocalPort4				= VIRTUALREG_START+457,
	kVRegTxcPrimaryRemoteIp4				= VIRTUALREG_START+458,
	kVRegTxcPrimaryRemotePort4				= VIRTUALREG_START+459,
	kVRegTxcSecondaryLocalPort4				= VIRTUALREG_START+460,
	kVRegTxcSecondaryRemoteIp4				= VIRTUALREG_START+461,
	kVRegTxcSecondaryRemotePort4			= VIRTUALREG_START+462,
	
	kVRegMailBoxAcquire						= VIRTUALREG_START+463,
	kVRegMailBoxRelease						= VIRTUALREG_START+464,
	kVRegMailBoxAbort						= VIRTUALREG_START+465,
	kVRegMailBoxTimeoutNS					= VIRTUALREG_START+466,		//	Units are 100 ns, not nanoseconds!

    kVRegRxc_2DecodeSelectionMode1          = VIRTUALREG_START+467,
    kVRegRxc_2DecodeProgramNumber1          = VIRTUALREG_START+468,
    kVRegRxc_2DecodeProgramPID1             = VIRTUALREG_START+469,
    kVRegRxc_2DecodeAudioNumber1            = VIRTUALREG_START+470,

    kVRegRxc_2DecodeSelectionMode2          = VIRTUALREG_START+471,
    kVRegRxc_2DecodeProgramNumber2          = VIRTUALREG_START+472,
    kVRegRxc_2DecodeProgramPID2             = VIRTUALREG_START+473,
    kVRegRxc_2DecodeAudioNumber2            = VIRTUALREG_START+474,

    kVRegTxc_2EncodeVideoFormat1            = VIRTUALREG_START+475,
    kVRegTxc_2EncodeUllMode1				= VIRTUALREG_START+476,
    kVRegTxc_2EncodeBitDepth1               = VIRTUALREG_START+477,
    kVRegTxc_2EncodeChromaSubSamp1          = VIRTUALREG_START+478,
    kVRegTxc_2EncodeMbps1                   = VIRTUALREG_START+479,
	kVRegTxc_2EncodeAudioChannels1			= VIRTUALREG_START+480,
	kVRegTxc_2EncodeStreamType1             = VIRTUALREG_START+481,
    kVRegTxc_2EncodeProgramPid1             = VIRTUALREG_START+482,
    kVRegTxc_2EncodeVideoPid1               = VIRTUALREG_START+483,
    kVRegTxc_2EncodePcrPid1					= VIRTUALREG_START+484,
    kVRegTxc_2EncodeAudio1Pid1              = VIRTUALREG_START+485,
    
    kVRegTxc_2EncodeVideoFormat2            = VIRTUALREG_START+486,
    kVRegTxc_2EncodeUllMode2				= VIRTUALREG_START+487,
    kVRegTxc_2EncodeBitDepth2               = VIRTUALREG_START+488,
    kVRegTxc_2EncodeChromaSubSamp2          = VIRTUALREG_START+489,
    kVRegTxc_2EncodeMbps2                   = VIRTUALREG_START+490,
	kVRegTxc_2EncodeAudioChannels2			= VIRTUALREG_START+491,
    kVRegTxc_2EncodeStreamType2             = VIRTUALREG_START+492,
    kVRegTxc_2EncodeProgramPid2             = VIRTUALREG_START+493,
    kVRegTxc_2EncodeVideoPid2               = VIRTUALREG_START+494,
    kVRegTxc_2EncodePcrPid2					= VIRTUALREG_START+495,
    kVRegTxc_2EncodeAudio1Pid2              = VIRTUALREG_START+496,

    kVReg2022_7Enable						= VIRTUALREG_START+497,
	...
	kVRegLastAJA							= VIRTUALREG_START+523,		///< @brief	The last AJA virtual register slot

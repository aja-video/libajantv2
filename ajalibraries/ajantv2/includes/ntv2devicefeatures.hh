...
/**
	...
	@note		Generated by '.\sdkgen\ntv2sdkgen.py' on 06/22/21 11:04:38.
**/
...
/**
	@return		True if the device can rasterize 4 different signals into a single HDMI output
	@param[in]	inDeviceID		Specifies the NTV2DeviceID of interest.
**/
AJAExport bool NTV2DeviceCanDoHDMIMultiRasterView (const NTV2DeviceID inDeviceID);

...
//#define NTV2_DEPRECATE_14_4		//	If defined, excludes all symbols/APIs to be deprecated in SDK 14.4
...
// Platform dependent
	...
	#endif
	#if !defined(NTV2_DEPRECATE_14_4)
		#define NTV2_DEPRECATE_14_4		//	(future ready)
	#endif
#endif

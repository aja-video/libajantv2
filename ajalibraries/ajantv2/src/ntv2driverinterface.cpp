...
#endif
	{
		if (::NTV2DeviceHasSPIFlash(_boardID))
		{
			...
			switch (_boardID)
			{
				...
				case DEVICE_ID_KONA5_2X4K:						bitFileInfo.bitFileType = NTV2_BITFILE_KONA5_2_MAIN;				break;
				...
				case DEVICE_ID_CORVID44_2X4K:                bitFileInfo.bitFileType = NTV2_BITFILE_CORVID44_8K_2_MAIN;			break;

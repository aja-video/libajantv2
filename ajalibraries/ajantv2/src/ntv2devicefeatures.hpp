	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_IO4KIP_2022
			break;	//  DEVICE_ID_IO4KIP_2022
		...
		case DEVICE_ID_IO4KIP_2110:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_IO4KIP_2110
			break;	//  DEVICE_ID_IO4KIP_2110
		...
		case DEVICE_ID_KONAIP_4TX_2110:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_KONAIP_4TX_2110
			break;	//  DEVICE_ID_KONAIP_4TX_2110
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_IO4KIP_2022
			break;	//  DEVICE_ID_IO4KIP_2022
		...
		case DEVICE_ID_IO4KIP_2110:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_IO4KIP_2110
			break;	//  DEVICE_ID_IO4KIP_2110
		...
		case DEVICE_ID_KONAIP_4TX_2110:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_KONAIP_4TX_2110
			break;	//  DEVICE_ID_KONAIP_4TX_2110
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_IO4KIP_2022
			break;	//  DEVICE_ID_IO4KIP_2022
		...
		case DEVICE_ID_IO4KIP_2110:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_IO4KIP_2110
			break;	//  DEVICE_ID_IO4KIP_2110
		...
		case DEVICE_ID_KONAIP_4TX_2110:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_KONAIP_4TX_2110
			break;	//  DEVICE_ID_KONAIP_4TX_2110
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_IO4KIP_2022
			break;	//  DEVICE_ID_IO4KIP_2022
		...
		case DEVICE_ID_IO4KIP_2110:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_IO4KIP_2110
			break;	//  DEVICE_ID_IO4KIP_2110
		...
		case DEVICE_ID_KONAIP_4TX_2110:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_KONAIP_4TX_2110
			break;	//  DEVICE_ID_KONAIP_4TX_2110
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_IO4KIP_2022
			break;	//  DEVICE_ID_IO4KIP_2022
		...
		case DEVICE_ID_IO4KIP_2110:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_IO4KIP_2110
			break;	//  DEVICE_ID_IO4KIP_2110
...
ULWord NTV2DeviceGetActiveMemorySize (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 0x80000000;
		case DEVICE_ID_IO4KIP_2110:	return 0x80000000;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0x37800000;
	#if !defined (NTV2_DEPRECATE)
...
UWord NTV2DeviceGetDACVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 0;
		case DEVICE_ID_IO4KIP_2110:	return 0;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetHDMIVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 4;
		case DEVICE_ID_IO4KIP_2110:	return 4;
		case DEVICE_ID_KONAIP_4TX_2110:	return 3;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetLUTVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 2;
		case DEVICE_ID_IO4KIP_2110:	return 2;
		case DEVICE_ID_KONAIP_4TX_2110:	return 1;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
UWord NTV2DeviceGetMaxAudioChannels (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 16;
		case DEVICE_ID_IO4KIP_2110:	return 16;
		case DEVICE_ID_KONAIP_4TX_2110:	return 16;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetMaxRegisterNumber (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return kRegReserved511;
		case DEVICE_ID_IO4KIP_2110:	return kRegReserved511;
		case DEVICE_ID_KONAIP_4TX_2110:	return kRegReserved511;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetMaxTransferCount (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return BIT(21) - 1;
		case DEVICE_ID_IO4KIP_2110:	return BIT(21) - 1;
		case DEVICE_ID_KONAIP_4TX_2110:	return BIT(21) - 1;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetNumDMAEngines (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 2;
		case DEVICE_ID_IO4KIP_2110:	return 2;
		case DEVICE_ID_KONAIP_4TX_2110:	return 2;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetNumVideoChannels (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 8;
		case DEVICE_ID_IO4KIP_2110:	return 8;
		case DEVICE_ID_KONAIP_4TX_2110:	return 4;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetPingLED (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return BIT(16);
		case DEVICE_ID_IO4KIP_2110:	return BIT(16);
		case DEVICE_ID_KONAIP_4TX_2110:	return BIT(16);
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetUFCVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 1;
		case DEVICE_ID_IO4KIP_2110:	return 1;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
...
UWord NTV2DeviceGetNumCSCs (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 5;
		case DEVICE_ID_IO4KIP_2110:	return 5;
		case DEVICE_ID_KONAIP_4TX_2110:	return 5;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
UWord NTV2DeviceGetNumHDMIAudioOutputChannels (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP_2022:	return 8;
		case DEVICE_ID_IO4KIP_2110:	return 8;
		case DEVICE_ID_KONAIP_4TX_2110:	return 8;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID

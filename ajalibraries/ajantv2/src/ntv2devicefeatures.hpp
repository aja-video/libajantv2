	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAHDMI:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_KONAHDMI
			break;	//  DEVICE_ID_KONAHDMI
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAHDMI:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_KONAHDMI
			break;	//  DEVICE_ID_KONAHDMI
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAHDMI:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_KONAHDMI
			break;	//  DEVICE_ID_KONAHDMI
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAHDMI:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_KONAHDMI
			break;	//  DEVICE_ID_KONAHDMI
...
UWord NTV2DeviceGetDACVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAHDMI:	return 0;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID

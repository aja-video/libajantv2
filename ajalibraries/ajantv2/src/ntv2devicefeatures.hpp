/**
	...
	@note		Generated by './ajalibraries/ajantv2/sdkgen/ntv2sdkgen.py' on Mon Jan 22 17:15:23 2018.
**/
...
ULWord NTV2DeviceGetMaxRegisterNumber (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:		return kRegXptSelectGroup10;
	...
	switch (inVideoFormat)
	{
		...
		case NTV2_FORMAT_1080p_2K_4795:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_CORVID44:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_2K_4795:
				case DEVICE_ID_IO4KUFC:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_IOXT:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_2K_4795
			break;	//  NTV2_FORMAT_1080p_2K_4795
		...
		case NTV2_FORMAT_1080p_2K_4800:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_CORVID44:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_2K_4800:
				case DEVICE_ID_IO4KUFC:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_IOXT:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_2K_4800
			break;	//  NTV2_FORMAT_1080p_2K_4800
		...
		case NTV2_FORMAT_1080p_2K_5000:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_CORVID44:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_2K_5000:
				case DEVICE_ID_IO4KUFC:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_IOXT:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_2K_5000
			break;	//  NTV2_FORMAT_1080p_2K_5000
		...
		case NTV2_FORMAT_1080p_2K_5994:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_CORVID44:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_2K_5994:
				case DEVICE_ID_IO4KUFC:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_IOXT:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_2K_5994
			break;	//  NTV2_FORMAT_1080p_2K_5994
		...
		case NTV2_FORMAT_1080p_2K_6000:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_CORVID44:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_2K_6000:
				case DEVICE_ID_IO4KUFC:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_IOXT:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_2K_6000
			break;	//  NTV2_FORMAT_1080p_2K_6000
		...
		case NTV2_FORMAT_1080p_5000:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_KONALHIDVI:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_5000:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_IOIP_2022:
				case DEVICE_ID_TTAP:
				case DEVICE_ID_KONA1:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_5000
			break;	//  NTV2_FORMAT_1080p_5000
		...
		case NTV2_FORMAT_1080p_5994:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_KONALHIDVI:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_5994:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_IOIP_2022:
				case DEVICE_ID_TTAP:
				case DEVICE_ID_KONA1:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_5994
			break;	//  NTV2_FORMAT_1080p_5994
		...
		case NTV2_FORMAT_1080p_6000:
			switch (inDeviceID)
			{
				...
				case DEVICE_ID_KONALHIDVI:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_FORMAT_1080p_6000:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_IOIP_2022:
				case DEVICE_ID_TTAP:
				case DEVICE_ID_KONAIP_2TX_1SFP_J2K:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_FORMAT_1080p_6000
			break;	//  NTV2_FORMAT_1080p_6000

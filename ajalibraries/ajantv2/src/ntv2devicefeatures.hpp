	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_KONA1
			break;	//  DEVICE_ID_KONA1
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_KONA1
			break;	//  DEVICE_ID_KONA1
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_KONA1
			break;	//  DEVICE_ID_KONA1
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_KONA1
			break;	//  DEVICE_ID_KONA1
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA1:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_KONA1
			break;	//  DEVICE_ID_KONA1

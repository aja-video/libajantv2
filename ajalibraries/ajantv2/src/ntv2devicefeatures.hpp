/**
	...
	@note		Generated by '.\sdkgen\ntv2sdkgen.py' on 11/19/19 11:39:57.
**/
	...
	switch (inWidgetID)
	{
		...
		case NTV2_WgtHDMIOut1v5:
			switch (inDeviceID)
			{
				case DEVICE_ID_T3TAP:
					return true;
			#if defined(_DEBUG)		// These devices don't support NTV2_WgtHDMIOut1v5:
				case DEVICE_ID_KONALHI:
				case DEVICE_ID_CORVID44_8KMK:
				case DEVICE_ID_IOEXPRESS:
				case DEVICE_ID_IO4KPLUS:
			...
			#endif
					break;
			}	//  switch on inDeviceID for NTV2_WgtHDMIOut1v5
			break;	//  NTV2_WgtHDMIOut1v5

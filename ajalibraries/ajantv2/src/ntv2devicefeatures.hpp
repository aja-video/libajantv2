/**
	...
	@note		Generated by 'D:\Projects\ntv2_kona\ajalibraries\ajantv2\sdkgen\ntv2sdkgen.py' on 08/09/18 11:17:06.
**/
...
/**
	...
	True if the board supports the new 12g routing xpt
**/
...
ULWord NTV2DeviceGetActiveMemorySize (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA5:		return 0xF8000000;
...
UWord NTV2DeviceGetNumCSCs (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONA5_12G:	return 5;

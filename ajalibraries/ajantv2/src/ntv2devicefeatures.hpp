	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_IO4KIP
			break;	//  DEVICE_ID_IO4KIP
		...
		case DEVICE_ID_KONAALPHA:
			switch (inVideoFormat)
			{
				...
				default:
					break;
			}	//  switch on inVideoFormat for device DEVICE_ID_KONAALPHA
			break;	//  DEVICE_ID_KONAALPHA
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_IO4KIP
			break;	//  DEVICE_ID_IO4KIP
		...
		case DEVICE_ID_KONAALPHA:
			switch (inFBFormat)
			{
				...
				default:
					break;
			}	//  switch on inFBFormat for device DEVICE_ID_KONAALPHA
			break;	//  DEVICE_ID_KONAALPHA
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_IO4KIP
			break;	//  DEVICE_ID_IO4KIP
		...
		case DEVICE_ID_KONAALPHA:
			switch (inWidgetID)
			{
				...
				default:
					break;
			}	//  switch on inWidgetID for device DEVICE_ID_KONAALPHA
			break;	//  DEVICE_ID_KONAALPHA
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_IO4KIP
			break;	//  DEVICE_ID_IO4KIP
		...
		case DEVICE_ID_KONAALPHA:
			switch (inDSKMode)
			{
				...
				default:
					break;
			}	//  switch on inDSKMode for device DEVICE_ID_KONAALPHA
			break;	//  DEVICE_ID_KONAALPHA
	...
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_IO4KIP
			break;	//  DEVICE_ID_IO4KIP
		...
		case DEVICE_ID_KONAALPHA:
			switch (inInputSource)
			{
				...
				default:
					break;
			}	//  switch on inInputSource for device DEVICE_ID_KONAALPHA
			break;	//  DEVICE_ID_KONAALPHA
...
ULWord NTV2DeviceGetActiveMemorySize (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return 0x80000000;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0x37800000;
		case DEVICE_ID_KONAALPHA:	return 0x40000000;
	#if !defined (NTV2_DEPRECATE)
...
UWord NTV2DeviceGetDACVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return 0;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0;
		case DEVICE_ID_KONAALPHA:	return 0;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetLUTVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return 2;
		case DEVICE_ID_KONAIP_4TX_2110:	return 1;
		case DEVICE_ID_KONAALPHA:	return 1;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
UWord NTV2DeviceGetMaxAudioChannels (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return 16;
		case DEVICE_ID_KONAIP_4TX_2110:	return 16;
		case DEVICE_ID_KONAALPHA:	return 16;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetMaxRegisterNumber (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return kRegReserved511;
		case DEVICE_ID_KONAIP_4TX_2110:	return kRegReserved511;
		case DEVICE_ID_KONAALPHA:	return kRegXptSelectGroup10;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetMaxTransferCount (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return BIT(21) - 1;
		case DEVICE_ID_KONAIP_4TX_2110:	return BIT(21) - 1;
		case DEVICE_ID_KONAALPHA:	return BIT(21) - 1;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetNumDMAEngines (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_KONAALPHA:	return 2;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetPingLED (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return BIT(16);
		case DEVICE_ID_KONAIP_4TX_2110:	return BIT(16);
		case DEVICE_ID_KONAALPHA:	return BIT(19);
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;
	#endif	//	!defined (NTV2_DEPRECATE)
	}	//	switch on inDeviceID
...
ULWord NTV2DeviceGetUFCVersion (const NTV2DeviceID inDeviceID)
{
	switch (inDeviceID)
	{
		...
		case DEVICE_ID_IO4KIP:		return 1;
		case DEVICE_ID_KONAIP_4TX_2110:	return 0;
		case DEVICE_ID_KONAALPHA:	return 1;
	#if !defined (NTV2_DEPRECATE)
		default:	return 0;

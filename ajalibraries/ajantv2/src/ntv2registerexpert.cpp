...
class RegisterExpert
{
	public:
		explicit RegisterExpert ()
		{
			...
			DefineRegName	(kVReg2022_2EncodeVideoFormatCh1,		"kVReg2022_2EncodeVideoFormatCh1");
			DefineRegName	(kVReg2022_2EncodeUllModeCh1,			"kVReg2022_2EncodeUllModeCh1");
			DefineRegName	(kVReg2022_2EncodeBitDepthCh1,			"kVReg2022_2EncodeBitDepthCh1");
			DefineRegName	(kVReg2022_2EncodeChromaSubSampCh1,		"kVReg2022_2EncodeChromaSubSampCh1");
			DefineRegName	(kVReg2022_2EncodeCodeBlockSizeCh1,		"kVReg2022_2EncodeCodeBlockSizeCh1");
			DefineRegName	(kVReg2022_2EncodeMbpsCh1,				"kVReg2022_2EncodeMbpsCh1");
			DefineRegName	(kVReg2022_2EncodePidCh1,				"kVReg2022_2EncodePidCh1");
			DefineRegName	(kVReg2022_2EncodeStreamTypeCh1,		"kVReg2022_2EncodeStreamTypeCh1");
			DefineRegName	(kVReg2022_2EncodeVideoFormatCh2,		"kVReg2022_2EncodeVideoFormatCh2");
			DefineRegName	(kVReg2022_2EncodeUllModeCh2,			"kVReg2022_2EncodeUllModeCh2");
			DefineRegName	(kVReg2022_2EncodeBitDepthCh2,			"kVReg2022_2EncodeBitDepthCh2");
			DefineRegName	(kVReg2022_2EncodeChromaSubSampCh2,		"kVReg2022_2EncodeChromaSubSampCh2");
			DefineRegName	(kVReg2022_2EncodeCodeBlockSizeCh2,		"kVReg2022_2EncodeCodeBlockSizeCh2");
			DefineRegName	(kVReg2022_2EncodeMbpsCh2,				"kVReg2022_2EncodeMbpsCh2");
			DefineRegName	(kVReg2022_2EncodePidCh2,				"kVReg2022_2EncodePidCh2");
			DefineRegName	(kVReg2022_2EncodeStreamTypeCh2,		"kVReg2022_2EncodeStreamTypeCh2");

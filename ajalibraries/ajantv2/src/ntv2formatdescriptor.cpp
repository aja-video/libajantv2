...
const AJA_LOCAL_STATIC NTV2FormatDescriptor	formatDescriptorTable [NTV2_NUM_STANDARDS] [NTV2_FBF_NUMFRAMEBUFFERFORMATS] =
{
	...
	{/////	NTV2_STANDARD_525											inNumLines						inNumPixels							inLinePitch								inFirstActiveLine
		...
		/* NTV2_FBF_8BIT_YCBCR_420PL3 */		AJA_FD_BEGIN			NUMACTIVELINES_525,				NUMCOMPONENTPIXELS,					NUMCOMPONENTPIXELS/4,					AJA_FD_END,
		...
		/* NTV2_FBF_8BIT_YCBCR_422PL3 */		AJA_FD_BEGIN			NUMACTIVELINES_525,				NUMCOMPONENTPIXELS,					NUMCOMPONENTPIXELS/4,					AJA_FD_END,
		/* NTV2_FBF_10BIT_RAW_RGB */			AJA_FD_NOTSUPPORTED,
		/* NTV2_FBF_10BIT_RAW_YCBCR */			AJA_FD_NOTSUPPORTED,
		/* NTV2_FBF_10BIT_YCBCR_420PL3_LE */	AJA_FD_BEGIN			NUMACTIVELINES_525,				NUMCOMPONENTPIXELS,					NUMCOMPONENTPIXELS/2,					AJA_FD_END,
		/* NTV2_FBF_10BIT_YCBCR_422PL3_LE */	AJA_FD_BEGIN			NUMACTIVELINES_525,				NUMCOMPONENTPIXELS,					NUMCOMPONENTPIXELS/2,					AJA_FD_END,
		/* NTV2_FBF_10BIT_YCBCR_420PL2 */		AJA_FD_NOTSUPPORTED,
		/* NTV2_FBF_10BIT_YCBCR_422PL2 */		AJA_FD_NOTSUPPORTED,
...
void NTV2FormatDescriptor::FinalizePlanar (void)
{
	...
	switch (mPixelFormat)
	{
		...
		case NTV2_FBF_8BIT_YCBCR_422PL3:
		{
			...
			if (mPixelFormat == NTV2_FBF_8BIT_YCBCR_420PL3)
				chromaRasterBytes /= 2;		//	Half again for 4:2:0
		...
		case NTV2_FBF_10BIT_YCBCR_422PL3_LE:
		{
			...
			if (mPixelFormat == NTV2_FBF_10BIT_YCBCR_420PL3_LE)
				chromaRasterBytes /= 2;		//	Half again for 4:2:0				//	420 1080p:  1,036,800 bytes (0x000FD200)

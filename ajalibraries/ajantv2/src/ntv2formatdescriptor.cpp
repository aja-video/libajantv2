...
void NTV2FormatDescriptor::FinalizePlanar (void)
{
	...
	switch (mPixelFormat)
	{
		case NTV2_FBF_10BIT_YCBCR_420PL2:	mNumPlanes = 2;	mLinePitch[0] = linePitch * 4;	mLinePitch[1] = linePitch * 2;	break;
		case NTV2_FBF_10BIT_YCBCR_422PL2:	mNumPlanes = 2;	mLinePitch[0] = linePitch * 4;	mLinePitch[1] = linePitch * 2;	break;	//	<== Check this
		case NTV2_FBF_8BIT_YCBCR_420PL2:	mNumPlanes = 2;	mLinePitch[0] = numPixels;		mLinePitch[1] = numPixels / 2;	break;
		case NTV2_FBF_8BIT_YCBCR_422PL2:	mNumPlanes = 2;	mLinePitch[0] = linePitch * 4;	mLinePitch[1] = linePitch * 2;	break;	//	<== Check this

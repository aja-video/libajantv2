...
const char * NTV2DeviceIDString (const NTV2DeviceID id)
{
	switch (id)
	{
		...
		NTV2DEBUG_ENUM_CASE_RETURN_STR(DEVICE_ID_KONA5_4X12G);
		NTV2DEBUG_ENUM_CASE_RETURN_STR(DEVICE_ID_CORVID44_12G);
...
const char *NTV2FrameBufferFormatString (NTV2FrameBufferFormat fmt)
{
	switch (fmt)
	{
		...
		NTV2DEBUG_ENUM_CASE_RETURN_STR(NTV2_FBF_PRORES);

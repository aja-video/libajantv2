...
const char * NTV2DeviceIDString (const NTV2DeviceID id)
{
	switch (id)
	{
		...
		case DEVICE_ID_KONA5_4X12G:					return "DEVICE_ID_KONA5_4X12G";
...
const char *NTV2StandardString (NTV2Standard std)
{
	...
	switch (std)
	{
		...
		case NTV2_STANDARD_3840i:		result = "NTV2_STANDARD_3840i";			break;
		case NTV2_STANDARD_4096i:		result = "NTV2_STANDARD_4096i";			break; 
...
const char *NTV2VideoFormatString (NTV2VideoFormat fmt)
{
	...
	switch (fmt)
	{
		...
		case NTV2_FORMAT_4x2048x1080p_4795_B:		result = "NTV2_FORMAT_4x2048x1080p_4795_B";	break;
		case NTV2_FORMAT_4x2048x1080p_4800_B:		result = "NTV2_FORMAT_4x2048x1080p_4800_B";	break;
		case NTV2_FORMAT_4x1920x1080p_5000_B:		result = "NTV2_FORMAT_4x1920x1080p_5000_B";	break;
		case NTV2_FORMAT_4x1920x1080p_5994_B:		result = "NTV2_FORMAT_4x1920x1080p_5994_B";	break;
		case NTV2_FORMAT_4x1920x1080p_6000_B:		result = "NTV2_FORMAT_4x1920x1080p_6000_B";	break;
		case NTV2_FORMAT_4x2048x1080p_5000_B:		result = "NTV2_FORMAT_4x2048x1080p_5000_B";	break;
		case NTV2_FORMAT_4x2048x1080p_5994_B:		result = "NTV2_FORMAT_4x2048x1080p_5994_B";	break;
		case NTV2_FORMAT_4x2048x1080p_6000_B:		result = "NTV2_FORMAT_4x2048x1080p_6000_B";	break;
		case NTV2_FORMAT_3840x2160p_5000_B:			result = "NTV2_FORMAT_3840x2160p_5000_B";	break;
		case NTV2_FORMAT_3840x2160p_5994_B:			result = "NTV2_FORMAT_3840x2160p_5994_B";	break;
		case NTV2_FORMAT_3840x2160p_6000_B:			result = "NTV2_FORMAT_3840x2160p_6000_B";	break;
		case NTV2_FORMAT_4096x2160p_4795_B:			result = "NTV2_FORMAT_4096x2160p_4795_B";	break;
		case NTV2_FORMAT_4096x2160p_4800_B:			result = "NTV2_FORMAT_4096x2160p_4800_B";	break;
		case NTV2_FORMAT_4096x2160p_5000_B:			result = "NTV2_FORMAT_4096x2160p_5000_B";	break;
		case NTV2_FORMAT_4096x2160p_5994_B:			result = "NTV2_FORMAT_4096x2160p_5994_B";	break;
		case NTV2_FORMAT_4096x2160p_6000_B:			result = "NTV2_FORMAT_4096x2160p_6000_B";	break;
		case NTV2_FORMAT_4x3840x2160p_2398:			result = "NTV2_FORMAT_4x3840x2160p_2398";	break;
		case NTV2_FORMAT_4x3840x2160p_2400:			result = "NTV2_FORMAT_4x3840x2160p_2400";	break;
		case NTV2_FORMAT_4x3840x2160p_2500:			result = "NTV2_FORMAT_4x3840x2160p_2500";	break;
		case NTV2_FORMAT_4x3840x2160p_2997:			result = "NTV2_FORMAT_4x3840x2160p_2997";	break;
		case NTV2_FORMAT_4x3840x2160p_3000:			result = "NTV2_FORMAT_4x3840x2160p_3000";	break;
		case NTV2_FORMAT_4x3840x2160p_5000:			result = "NTV2_FORMAT_4x3840x2160p_5000";	break;
		case NTV2_FORMAT_4x3840x2160p_5994:			result = "NTV2_FORMAT_4x3840x2160p_5994";	break;
		case NTV2_FORMAT_4x3840x2160p_6000:			result = "NTV2_FORMAT_4x3840x2160p_6000";	break;
		case NTV2_FORMAT_4x3840x2160p_5000_B:		result = "NTV2_FORMAT_4x3840x2160p_5000_B";	break;
		case NTV2_FORMAT_4x3840x2160p_5994_B:		result = "NTV2_FORMAT_4x3840x2160p_5994_B";	break;
		case NTV2_FORMAT_4x3840x2160p_6000_B:		result = "NTV2_FORMAT_4x3840x2160p_6000_B";	break;
		case NTV2_FORMAT_4x4096x2160p_2398:			result = "NTV2_FORMAT_4x4096x2160p_2398";	break;
		case NTV2_FORMAT_4x4096x2160p_2400:			result = "NTV2_FORMAT_4x4096x2160p_2400";	break;
		case NTV2_FORMAT_4x4096x2160p_2500:			result = "NTV2_FORMAT_4x4096x2160p_2500";	break;
		case NTV2_FORMAT_4x4096x2160p_2997:			result = "NTV2_FORMAT_4x4096x2160p_2997";	break;
		case NTV2_FORMAT_4x4096x2160p_3000:			result = "NTV2_FORMAT_4x4096x2160p_3000";	break;
		case NTV2_FORMAT_4x4096x2160p_4795:			result = "NTV2_FORMAT_4x4096x2160p_4795";	break;
		case NTV2_FORMAT_4x4096x2160p_4800:			result = "NTV2_FORMAT_4x4096x2160p_4800";	break;
		case NTV2_FORMAT_4x4096x2160p_5000:			result = "NTV2_FORMAT_4x4096x2160p_5000";	break;
		case NTV2_FORMAT_4x4096x2160p_5994:			result = "NTV2_FORMAT_4x4096x2160p_5994";	break;
		case NTV2_FORMAT_4x4096x2160p_6000:			result = "NTV2_FORMAT_4x4096x2160p_6000";	break;
		case NTV2_FORMAT_4x4096x2160p_4795_B:		result = "NTV2_FORMAT_4x4096x2160p_4795_B";	break;
		case NTV2_FORMAT_4x4096x2160p_4800_B:		result = "NTV2_FORMAT_4x4096x2160p_4800_B";	break;
		case NTV2_FORMAT_4x4096x2160p_5000_B:		result = "NTV2_FORMAT_4x4096x2160p_5000_B";	break;
		case NTV2_FORMAT_4x4096x2160p_5994_B:		result = "NTV2_FORMAT_4x4096x2160p_5994_B";	break;
		case NTV2_FORMAT_4x4096x2160p_6000_B:		result = "NTV2_FORMAT_4x4096x2160p_6000_B";	break;
		...
		case NTV2_FORMAT_END_UHD2_DEF_FORMATS:		result = "";								break;
		case NTV2_FORMAT_END_UHD2_FULL_DEF_FORMATS:	result = "";								break;

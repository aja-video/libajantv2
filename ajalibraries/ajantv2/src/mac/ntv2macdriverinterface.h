...
class CNTV2MacDriverInterface : public CNTV2DriverInterface
{
	...
	**/
	///@{
	AJA_VIRTUAL bool	WriteRegister (ULWord inRegNum,  ULWord inValue,  ULWord inMask = 0xFFFFFFFF,  ULWord inShift = 0);
	...
	AJA_VIRTUAL bool	DmaTransfer (NTV2DMAEngine inDMAEngine,
									bool inIsRead,

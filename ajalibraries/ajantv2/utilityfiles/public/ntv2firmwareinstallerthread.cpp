...
bool CNTV2FirmwareInstallerThread::ShouldUpdate(const NTV2DeviceID inDeviceID, const std::string designName) const
{
    ...
    name = GetPrimaryDesignName(DEVICE_ID_IO4KIP_2022);
    printf("DEVICE_ID_IO4KIP_2022 name %s\n", name.c_str());

    name = GetPrimaryDesignName(DEVICE_ID_IO4KIP_2110);
    printf("DEVICE_ID_IO4KIP_2110 name %s\n", name.c_str());
#endif
	...
	case DEVICE_ID_KONA4:
	{
		if (m_device.IsKonaIPDevice())
			return (designName == GetPrimaryDesignName(DEVICE_ID_KONA4UFC) ||
					...
					designName == GetPrimaryDesignName(DEVICE_ID_KONAIP_4TX_2110) ||
    ...
    case DEVICE_ID_IO4KIP_2110:
        return (designName == GetPrimaryDesignName(DEVICE_ID_IO4KIP_2022) ||
                designName == GetPrimaryDesignName(DEVICE_ID_IO4KIP_2110));
	default: break;
	}
	return false;
}

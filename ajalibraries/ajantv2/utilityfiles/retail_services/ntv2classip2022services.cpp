...
ClassIP2022Services::ClassIP2022Services(NTV2DeviceID deviceID)
{
	(void) deviceID;
    config = NULL;
...
ClassIP2022Services::~ClassIP2022Services()
{
    if (config != NULL)
    {
        delete config;
...
//-------------------------------------------------------------------------------------------------------
void ClassIP2022Services::SetDeviceXPointPlayback ()
{
...
//-------------------------------------------------------------------------------------------------------
void ClassIP2022Services::SetDeviceXPointCapture ()
{
	// call superclass first
...
//-------------------------------------------------------------------------------------------------------
void ClassIP2022Services::SetDeviceMiscRegisters ()
{
	// call superclass first

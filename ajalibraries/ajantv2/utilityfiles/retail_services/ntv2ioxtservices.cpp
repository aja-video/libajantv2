...
//-------------------------------------------------------------------------------------------------------
void IoXTServices::SetDeviceXPointPlayback (GeneralFrameFormat genFrameFormat)
{
...
//-------------------------------------------------------------------------------------------------------
void IoXTServices::SetDeviceXPointCapture (GeneralFrameFormat genFrameFormat)
{
	// call superclass first
...
//-------------------------------------------------------------------------------------------------------
void IoXTServices::SetDeviceMiscRegisters (NTV2Mode mode)
{	
	// call superclass first

...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceXPointPlayback ()
{
    ...
    bool						bFb2HdrRGB			= mFb1Format == NTV2_FBF_48BIT_RGB;
...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceXPointCapture ()
{
	// call superclass first
...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceMiscRegisters ()
{
	// call superclass first

...
Corvid88Services::Corvid88Services()
{
}
...
//	UpdateAutoState
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::UpdateAutoState (void)
{
...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceXPointPlayback (GeneralFrameFormat genFrameFormat)
{
	...
	if (b4K)
	{
		...
		else
		{
			...
			{
				mCard->Connect (NTV2_XptCSC1VidInput, NTV2_Xpt425Mux1ARGB);
			}
		}
	}
	...
	if (b4K)
	{
		...
		else
		{
			...
			{
				mCard->Connect (NTV2_XptCSC2VidInput, NTV2_Xpt425Mux1BRGB);
			}
		}
	}
	else if (bCh2RGB)
	...
	if (b4K)
	{
		...
		else
		{
			...
			{
				mCard->Connect (NTV2_XptCSC3VidInput, NTV2_Xpt425Mux2ARGB);
			}
		}
	}
	else 
	...
	if (b4K)
	{
		...
		else
		{
			...
			{
				mCard->Connect (NTV2_XptCSC4VidInput, NTV2_Xpt425Mux2BRGB);
			}
		}
	}
	else 
...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceXPointCapture (GeneralFrameFormat genFrameFormat)
{
	// call superclass first
...
//-------------------------------------------------------------------------------------------------------
void Corvid88Services::SetDeviceMiscRegisters (NTV2Mode mode)
{
	// call superclass first
	...
	for(int i = 0; i < NTV2DeviceGetNumVideoOutputs(mCard->GetDeviceID()); i++)
		mCard->SetSDIOutLevelAtoLevelBConversion((NTV2Channel)i, bLevelA && b3GbTransportOut);

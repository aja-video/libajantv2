...
void Kona3GQuadServices::SetDeviceXPointCapture ()
{
	...
	if (b4K)
	{
		...
		{
		default:
		case NTV2_Quadrant1Select: mCard->Connect (NTV2_XptHDMIOutInput, inputColorSpace == NTV2_ColorSpaceModeRgb ? NTV2_XptCSC1VidYUV : NTV2_XptSDIIn1); break;
		case NTV2_Quadrant2Select: mCard->Connect (NTV2_XptHDMIOutInput, inputColorSpace == NTV2_ColorSpaceModeRgb ? NTV2_XptCSC2VidYUV : NTV2_XptSDIIn2); break;
		case NTV2_Quadrant3Select: mCard->Connect (NTV2_XptHDMIOutInput, inputColorSpace == NTV2_ColorSpaceModeRgb ? NTV2_XptCSC3VidYUV : NTV2_XptSDIIn3); break;
		case NTV2_Quadrant4Select: mCard->Connect (NTV2_XptHDMIOutInput, inputColorSpace == NTV2_ColorSpaceModeRgb ? NTV2_XptCSC4VidYUV : NTV2_XptSDIIn4); break;
		};
	}
	else 
	{

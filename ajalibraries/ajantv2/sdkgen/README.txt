...
ABOUT THE DEVICE FEATURES FILES IN 'CLASSES'
	...
	ntv2devicefeatures.hh		Contains all declarations of all functions generated by the 'ntv2devicefeatures.py' script
								from the CSV tables. A version of this file is checked into subversion, but it is not canonical.
...
ABOUT THE SDKGEN FILES
	...
	CanDo.csv                   CSV file (exported from ntv2devicefeatures.xls) containing rows of "NTV2DeviceCanDo" functions.

	ConversionModes.csv         CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2ConversionModes.

	DSKModes.csv                CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2DSKModes.

	FBFormats.csv               CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2FrameBufferFormats.

	GetNum.csv                  CSV file (exported from ntv2devicefeatures.xls) containing rows of "NTV2DeviceGetNum" functions.

	InputSources.csv            CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2InputSources.

	VideoFormats.csv            CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2VideoFormats.

	Widgets.csv                 CSV file (exported from ntv2devicefeatures.xls) containing supported per-device NTV2WidgetIDs.
...
RUNNING THE PYTHON SCRIPT
	...
	*	Assuming the current directory at build time is 'ntv2projects/classes' ...
	     $  ../sdkgen/ntv2devicefeatures.py   --csv ../sdkgen   --verbose
	*	The 'sdkgen/ntv2devicefeatures.py' file contains detailed information about the command line parameters.

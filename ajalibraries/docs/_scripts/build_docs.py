...
def main ():
    ...
    stuff_to_unzip =	[	{'name': 'MacSDK',	'rename': 'ntv2sdkmac_*.zip',					'to': 'ntv2sdkmac.zip'												},
    						...
    						{'name': 'WinSDK',	'move':   'win',								'from': 'AJAWinSDK/sdk/ajalibraries/ajantv2/src',		'to': ''	},
    						{'name': 'WinSDK',	'move':   'windows',							'from': 'AJAWinSDK/sdk/ajalibraries/ajabase/pnp',		'to': ''	},
    						{'name': 'WinSDK',	'rename': 'windows',							'to': 'winpnp'														},
    						{'name': 'WinSDK',	'move':   'windows',							'from': 'AJAWinSDK/sdk/ajalibraries/ajabase/system',	'to': ''	},
    						{'name': 'WinSDK',	'rename': 'windows',							'to': 'winsystem'													},
    						{'name': 'WinSDK',	'move':   'ntv2enums.h',						'from': 'AJAWinSDK/sdk/ajalibraries/ajantv2/includes',	'to': ''	},

...
4. To reconfigure the build with custom settings for certain CMake variables, additional CMake or build flags, etc. select the Configuration drop-down in the main toolbar, and select "Manage Configurations..." to open the CMakeSettings.json document. Make any changes to the build config, and select File -> Save.

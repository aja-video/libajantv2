...
typedef enum
{
	...
	kDriverWaitForInterruptDQ							= 11,
	kDriverWaitForInterrupt								= 12,
	kDriverGetInterruptCount							= 13,
	kDriverWaitForChangeEvent							= 14,
	kDriverGetTime										= 15,
	kDriverDMATransfer									= 16,
	kDriverRestoreProcAmpRegisters						= 17,
	kDriverSetBitFileInformation						= 18,	//	Unsupported starting in 12.4
	kDriverGetBitFileInformation						= 19,	//	Unsupported starting in 12.4
	kDriverSetDebugFilterStrings						= 20,
	kDriverGetDebugFilterStrings						= 21,
	kDriverAutoCirculateControl							= 22,
	kDriverAutoCirculateStatus							= 23,
	kDriverAutoCirculateTransfer						= 24,
	kDriverAutoCirculateFramestamp						= 25,
	kDriverSetDefaultDeviceForPID						= 26,	//	Unsupported when classic QuickTime dropped after SDK 14
	kDriverIsDefaultDeviceForPID						= 27,	//	Unsupported when classic QuickTime dropped after SDK 14
	kDriverSystemControl								= 28,
	kDriverSystemStatus									= 29,
	kDriverDMATransferEx								= 30,
	kDriverAcquireStreamForApplicationWithReference		= 31,
	kDriverReleaseStreamForApplicationWithReference		= 32,
	kDriverKernelLog									= 33,
	kDriverReadAudioBuffer								= 34,	//	Unsupported starting in 15.2
	kDriverNTV2Message									= 35,	//	Added in 12.0 -- all new driver functionality goes thru this NTV2Message call

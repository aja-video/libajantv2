...
/**
	@file		ntv2baremetaldriverinterface.h
	@brief		Declares the CNTV2BareMetalDriverInterface class.
	@copyright	(C) 2003-2022 AJA Video Systems, Inc.
**/
#ifndef NTV2BAREMETALDRIVERINTERFACE_H
#define NTV2BAREMETALDRIVERINTERFACE_H
...
/**
	@brief	BareMetal implementation of CNTV2DriverInterface.
**/
class CNTV2BareMetalDriverInterface : public CNTV2DriverInterface
{
	public:
							CNTV2BareMetalDriverInterface();
		AJA_VIRTUAL			~CNTV2BareMetalDriverInterface();
...
#endif	//	NTV2BAREMETALDRIVERINTERFACE_H

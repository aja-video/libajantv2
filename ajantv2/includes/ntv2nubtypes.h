...
namespace ntv2nub
{
	...
	inline void PUSHU8(const uint8_t inVal, RPCBlob & inArr)
	{
		inArr.push_back(inVal);
	}

	inline void PUSHU16(const uint16_t inVal, RPCBlob & inArr, const bool dontSwap = false)
	{
	...
	inline void PUSHU32(const uint32_t inVal, RPCBlob & inArr, const bool dontSwap = false)
	{
	...
	inline void PUSHU64(const uint64_t inVal, RPCBlob & inArr, const bool dontSwap = false)
	{
	...
	inline void POPU8 (uint8_t & outVal, const RPCBlob & inArr, std::size_t & inOutNdx)
	{
		outVal = inArr.at(inOutNdx++);
	}

	inline void POPU16 (uint16_t & outVal, const RPCBlob & inArr, std::size_t & inOutNdx, const bool dontSwap = false)
	{
		uint16_t _u16(0);
	...
	inline void POPU32 (uint32_t & outVal, const RPCBlob & inArr, std::size_t & inOutNdx, const bool dontSwap = false)
	{
		uint32_t _u32(0);
	...
	inline void POPU64 (uint64_t & outVal, const RPCBlob & inArr, std::size_t & inOutNdx, const bool dontSwap = false)
	{
		uint64_t _u64(0);
